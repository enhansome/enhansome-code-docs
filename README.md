...
| :--------------------------------------------------------------------------------------------------------------------- | ----: | :--------- | :-------------------------------------------------------------------------------------- |
| [`taskade/mcp`](https://github.com/taskade/mcp) ⭐ 165 \| 🐛 9 \| 🌐 TypeScript \| 📅 2026-07-29                        |  116+ | 2026-02-13 | [Taskade MCP Tutorial](tutorials/taskade-mcp-tutorial/)                                 |
...
| :--------------------------------------------------------------------------------------------------------------------------------- | :------------------------------------------------------- | ------: | :-------------------- | :------------------------------------------------------------------ |
| [`anomalyco/opencode`](https://github.com/anomalyco/opencode) ⭐ 201,130 \| 🐛 5,364 \| 🌐 TypeScript \| 📅 2026-08-25              | [OpenCode Tutorial](tutorials/opencode-tutorial/)        | 200,833 | 2026-08-24 (0d ago)   | terminal-native coding agent with strong provider and tool controls |
| [`open-webui/open-webui`](https://github.com/open-webui/open-webui) ⭐ 149,826 \| 🐛 232 \| 🌐 Python \| 📅 2026-08-25              | [Open WebUI Tutorial](tutorials/open-webui-tutorial/)    | 149,739 | 2026-08-24 (0d ago)   | self-hosted AI interface and model operations                       |
| [`browser-use/browser-use`](https://github.com/browser-use/browser-use) ⭐ 110,416 \| 🐛 384 \| 🌐 Python \| 📅 2026-08-25          | [Browser Use Tutorial](tutorials/browser-use-tutorial/)  | 110,311 | 2026-08-22 (2d ago)   | browser-native AI automation and agent execution                    |
| [`daytonaio/daytona`](https://github.com/daytonaio/daytona) ⭐ 71,888 \| 🐛 445 \| 📅 2026-07-24                                    | [Daytona Tutorial](tutorials/daytona-tutorial/)          |  71,896 | 2026-07-24 (31d ago)  | sandbox infrastructure for secure AI code execution                 |
| [`cline/cline`](https://github.com/cline/cline) ⭐ 66,803 \| 🐛 1,084 \| 🌐 TypeScript \| 📅 2026-08-25                             | [Cline Tutorial](tutorials/cline-tutorial/)              |  66,746 | 2026-08-23 (1d ago)   | agentic coding with terminal, browser, and MCP workflows            |
| [`Fission-AI/OpenSpec`](https://github.com/Fission-AI/OpenSpec) ⭐ 66,141 \| 🐛 201 \| 🌐 TypeScript \| 📅 2026-08-24               | [OpenSpec Tutorial](tutorials/openspec-tutorial/)        |  66,055 | 2026-08-24 (0d ago)   | spec-driven workflow layer for predictable AI-assisted delivery     |
| [`Mintplex-Labs/anything-llm`](https://github.com/Mintplex-Labs/anything-llm) ⭐ 65,164 \| 🐛 329 \| 🌐 JavaScript \| 📅 2026-08-25 | [AnythingLLM Tutorial](tutorials/anything-llm-tutorial/) |  65,134 | 2026-08-22 (2d ago)   | self-hosted RAG workspaces and agent workflows                      |
| [`continuedev/continue`](https://github.com/continuedev/continue) ⭐ 35,620 \| 🐛 938 \| 🌐 TypeScript \| 📅 2026-08-24             | [Continue Tutorial](tutorials/continue-tutorial/)        |  35,607 | 2026-08-24 (0d ago)   | IDE-native AI coding assistant architecture                         |
| [`TabbyML/tabby`](https://github.com/TabbyML/tabby) ⭐ 33,834 \| 🐛 331 \| 🌐 Rust \| 📅 2026-06-30                                 | [Tabby Tutorial](tutorials/tabby-tutorial/)              |  33,833 | 2026-06-30 (55d ago)  | self-hosted coding assistant platform for teams                     |
| [`vercel/ai`](https://github.com/vercel/ai) ⭐ 26,401 \| 🐛 1,714 \| 🌐 TypeScript \| 📅 2026-08-25                                 | [Vercel AI SDK Tutorial](tutorials/vercel-ai-tutorial/)  |  26,384 | 2026-08-24 (0d ago)   | production TypeScript AI app and agent SDK patterns                 |
...
| [`dyad-sh/dyad`](https://github.com/dyad-sh/dyad) ⭐ 21,314 \| 🐛 289 \| 🌐 TypeScript \| 📅 2026-08-25                             | [Dyad Tutorial](tutorials/dyad-tutorial/)                |  21,312 | 2026-08-23 (1d ago)   | local-first AI app generation workflows                             |
| [`stackblitz-labs/bolt.diy`](https://github.com/stackblitz-labs/bolt.diy) ⭐ 19,807 \| 🐛 131 \| 🌐 TypeScript \| 📅 2026-02-07     | [bolt.diy Tutorial](tutorials/bolt-diy-tutorial/)        |  19,803 | 2026-02-07 (198d ago) | open-source Bolt-style product builder stack                        |
...
| [`stagewise-io/stagewise`](https://github.com/stagewise-io/stagewise) ⭐ 6,788 \| 🐛 17 \| 🌐 TypeScript \| 📅 2026-08-17           | [Stagewise Tutorial](tutorials/stagewise-tutorial/)      |   6,787 | 2026-08-17 (7d ago)   | browser-context frontend coding agent workflows                     |
| [`cloudflare/vibesdk`](https://github.com/cloudflare/vibesdk) ⭐ 5,329 \| 🐛 13 \| 🌐 TypeScript \| 📅 2026-08-20                   | [VibeSDK Tutorial](tutorials/vibesdk-tutorial/)          |   5,328 | 2026-08-20 (4d ago)   | Cloudflare-native prompt-to-app platform architecture               |
...
Inspired by [Tutorial-Codebase-Knowledge](https://github.com/The-Pocket/Tutorial-Codebase-Knowledge) ⭐ 12,631 | 🐛 76 | 🌐 Python | 📅 2026-05-31 by The Pocket.
